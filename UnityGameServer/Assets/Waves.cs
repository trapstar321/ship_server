...
public class Waves : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            data.vertices[i] = new MeshSerializable.Vector3Serializable() { x = v.x, y = v.y, z = v.z };
            i++;
        }
        ...
        {
            data.uv[i] = new MeshSerializable.Vector2Serializable() { x = v.x, y = v.y };
            i++;
        }*/

        /*while (send < sendTries)
        {
            ServerSend.WavesMesh(data);
            send += 1;
        }*/
